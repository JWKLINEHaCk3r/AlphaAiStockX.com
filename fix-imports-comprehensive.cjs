...
const IMPORT_MAPPINGS = {
  ...
  '../../../components/ui/navigation-menu': '../../components/ui/navigation-menu',
  ...
  '../../../components/ui/toggle-group': '../../components/ui/toggle-group',
  '../../../components/ui/menubar': '../../components/ui/menubar',
  '../../../components/ui/context-menu': '../../components/ui/context-menu',
  '../../../components/ui/hover-card': '../../components/ui/hover-card',
  '../../../components/ui/aspect-ratio': '../../components/ui/aspect-ratio',
  '../../../components/ui/resizable': '../../components/ui/resizable',
  ...
  '../../../components/ui/breadcrumb': '../../components/ui/breadcrumb',
  '../../../components/ui/pagination': '../../components/ui/pagination',
  
  // Fix relative path issues for components in app folder
  './components/ui/': '../components/ui/',
  '../components/ui/': '../../components/ui/',
  
  // Trading components
  './components/ui/trading-dashboard-demo': '../../components/ui/trading-dashboard-demo',
  '../components/ui/trading-dashboard-demo': '../../components/ui/trading-dashboard-demo',
  './components/trading-dashboard-demo': '../components/ui/trading-dashboard-demo',
  '../components/trading-dashboard-demo': '../../components/ui/trading-dashboard-demo',
  
  // Navigation components
  'components/ui/navigation/index.tsx': '../components/ui/navigation/index',
  '../components/ui/navigation/index.tsx': '../../components/ui/navigation/index',
  './components/ui/navigation/index.tsx': '../components/ui/navigation/index',
...
const IMPORT_FIXES = [
  ...
  {
    pattern: /import\s+{\s*([^}]+)\s*}\s*from\s+['"]([^'"]+)['"]\s*;\s*import\s+{\s*([^}]+)\s*}\s*from\s+['"]([^'"]+)['"]\s*;/g,
    fix: (match, imports1, path1, imports2, path2) => {
      if (path1 === path2) {
  ...
  // Fix malformed import syntax
  {
    ...
    fix: (match, imports, path) => `import { ${imports.trim()} } from '${path}';`
  },
  ...
  // Fix React duplicate imports
  {
    pattern: /import\s+React\s+from\s+['"]react['"]\s*;\s*import\s+React\s+from\s+['"]react['"]\s*;/g,
    fix: "import React from 'react';"
  },
  
  // Fix use client directive placement
  {
    pattern: /(['"]use client['"])\s*;\s*(import.*)/g,
    fix: "'use client';\n\n$2"
  }
];
...
function fixImportsInFile(filePath) {
  ...
  const reactImports = content.match(/import\s+React.*from\s+['"]react['"]\s*;/g);

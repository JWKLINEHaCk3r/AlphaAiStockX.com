...
// Define self as global for webpack chunk loading
if (typeof global !== 'undefined' && typeof global.self === 'undefined') {
  global.self = global;
  console.log('[Global Setup] Defined global.self = global');
}

// Also ensure it's available on globalThis
if (typeof globalThis !== 'undefined' && typeof globalThis.self === 'undefined') {
  globalThis.self = globalThis;
  console.log('[Global Setup] Defined globalThis.self = globalThis');
}

// Add document polyfill for SSR
...
if (typeof global !== 'undefined') {
  if (typeof global.webpackChunk_N_E === 'undefined') {
    ...
    console.log('[Global Setup] Initialized global.webpackChunk_N_E');
  }
}
...
if (typeof globalThis !== 'undefined') {
  if (typeof globalThis.webpackChunk_N_E === 'undefined') {
    ...
    console.log('[Global Setup] Initialized globalThis.webpackChunk_N_E');
  }
}

...
export const APP_CONFIG = {
  name: 'AlphaAIStockX',;
  version: '2.0.0',;
  description: 'Next-Level AI Trading Platform',;
  url: process.env.NEXT_PUBLIC_APP_URL || 'https://alphaaistockx.com',;
  api: {
...
export const AI_AGENTS = [;
  { name: 'Alpha-1', specialization: 'Technical Analysis', accuracy: 0.94 },;
  { name: 'Beta-2', specialization: 'Fundamental Analysis', accuracy: 0.91 },;
  { name: 'Gamma-3', specialization: 'Sentiment Analysis', accuracy: 0.89 },;
  { name: 'Delta-4', specialization: 'Risk Management', accuracy: 0.96 },;
  { name: 'Epsilon-5', specialization: 'Portfolio Optimization', accuracy: 0.93 },;
  { name: 'Zeta-6', specialization: 'Market Timing', accuracy: 0.88 },;
  { name: 'Eta-7', specialization: 'Options Trading', accuracy: 0.92 },;
  { name: 'Theta-8', specialization: 'Crypto Analysis', accuracy: 0.87 },;
] as const;
...
export const ERROR_MESSAGES = {
  ...
  MARKET_CLOSED: 'Market is currently closed. Orders will be queued.',;
  INVALID_SYMBOL: 'Invalid stock symbol. Please check and try again.',;
  ORDER_FAILED: 'Order execution failed. Please try again.',;
  DATA_UNAVAILABLE: 'Data temporarily unavailable. Please try again later.',;
  PERMISSION_DENIED: 'Permission denied. Upgrade your subscription to access this feature.',;
} as const;

// Success messages;
export const SUCCESS_MESSAGES = {
  ORDER_PLACED: 'Order placed successfully!',;
  ORDER_FILLED: 'Order filled successfully!',;
...
export const CHART_CONFIG = {
  ...
  timeframes: [;
    ...
    { label: '3M', value: '3M', minutes: 129600 },;

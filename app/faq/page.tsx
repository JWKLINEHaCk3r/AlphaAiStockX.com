...
export default function FAQPage() {
  return (
    <div className="max-w-3xl mx-auto py-12 px-4">
      ...
      {/* Add dynamic FAQ accordion here
               powered by AI or static content */}
      <ul className="space-y-6">
        ...
        <li>
          <b>Does Algo Exchange have access to my funds?</b> No
               you retain full control. We only;
        ...
        <li>
          <b>Can I assess performance?</b> Yes
               every algorithm has live and historical analytics;
          backtests
               and explainable AI reports
        </li>
        <li>
          <b>How is risk managed?</b> Each algo has built-in risk controls
               and you can set your own;
          limits
        </li>
        <li>
          <b>Do I need to download anything?</b> No
               everything runs securely in the cloud
        </li>
        <li>
        ...
        <li>
          <b>Is there support?</b> Yes
               contact us or schedule a video call for a walkthrough
        </li>
      </ul>
    </div>
  )

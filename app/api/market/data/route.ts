...
export async function GET() {
  try {
    ...
    // Mock market data
    const marketData = { indices: { 'S&P500': { value: 4756.50, change: 0.85, changePercent: 1.82 }, 'NASDAQ': { value: 14845.30, change: 125.20, changePercent: 0.85 }, 'DOW': { value: 37248.90, change: -45.80, changePercent: -0.12 }

            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-black/20 border border-green-500/30 rounded-lg p-4">
                  ...
                  <div className="text-gray-400 text-sm mb-4">Commission-free stock trading API</div>
                  <button className="w-full bg-green-600 text-white py-2 rounded">Connect Alpaca</button>
                </div>
                
                <div className="bg-black/20 border border-blue-500/30 rounded-lg p-4">
                  <div className="text-blue-400 text-lg font-semibold mb-2">Interactive Brokers</div>
                  <div className="text-gray-400 text-sm mb-4">Professional trading platform</div>
                  <button className="w-full border border-blue-600 text-blue-400 py-2 rounded">Connect IBKR</button>
                </div>
              </div>
            </div>
          </div>

    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-red-900 to-orange-900 flex items-center justify-center p-4">
      <Card className="w-full max-w-md bg-black/50 border-red-500/20 backdrop-blur-xl">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl font-bold text-white">Oops! Something went wrong</CardTitle>
          <CardDescription className="text-gray-300">
            Our AI encountered an unexpected error. Don't worry, we're on it!
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="text-center text-sm text-gray-400">Error ID: {error.digest || "Unknown"}</div>
          <Button
            onClick={reset}
          ...
          <div className="text-center text-xs text-gray-500 mt-6">AlphaAIStockX - Powered by Quantum AI</div>
        </CardContent>
      </Card>
    </div>
  )

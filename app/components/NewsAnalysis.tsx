  ...
  useEffect(() => {
    ...
    const mockNews = [
      ...
      },
      {
        ...
        summary: "Tesla's Shanghai factory reports temporary production slowdowns due to supply chain disruptions.",
        sentiment: "bearish",
        confidence: 78,
        impact: "medium",
        source: "CNBC",
      ...
      },
      {
        ...
        summary: "Semiconductor companies report unprecedented demand for AI processing chips, driving sector growth.",
        sentiment: "bullish",
        confidence: 95,
        impact: "high",
        source: "TechCrunch",
      ...
      },
      {
        ...
        summary: "Crude oil futures drop as OPEC+ production increases raise concerns about market oversupply.",
        sentiment: "bearish",
        confidence: 83,
        impact: "medium",
        source: "MarketWatch",
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div className="text-center p-4 bg-purple-500/10 rounded-lg border border-purple-500/30">
              ...
              <p className="text-2xl font-bold text-purple-400">{sentimentSummary?.avgConfidence.toFixed(0)}%</p>
            ...
            >
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  ...
                  <Badge
                    variant={
                      article.impact === "high" ? "destructive" : article.impact === "medium" ? "secondary" : "default"
                    }
                  >

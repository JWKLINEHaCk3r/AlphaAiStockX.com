const IONOSDeploymentGuide = () => {
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-lg">
      ...
      <p className="text-lg mb-6 text-gray-600">Follow these steps to deploy your application on IONOS:</p>
      ...
      <ol className="list-decimal list-inside space-y-6">
        ...
        <li>
          ...
          <p className="mt-2">
            ...
            <code className="bg-gray-100 px-1 rounded">/build</code> directory). You may need to configure a reverse
            proxy (e.g., using Nginx or Apache) to route requests to your application.
          </p>
        </li>
        <li>
          ...
          <p className="mt-2">
            ...
            if you have a <code className="bg-gray-100 px-1 rounded">start</code> script in your{" "}
        ...
        <li>
          ...
          <p className="mt-2">
            ...
            <code className="bg-gray-100 px-1 rounded">/etc/nginx/sites-available/your-app</code>) with the following
            content:
          </p>
          <pre className="bg-gray-100 p-3 rounded mt-2 overflow-x-auto">
            <code>

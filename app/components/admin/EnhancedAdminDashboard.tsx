                      ...
                      <div className="flex items-center space-x-4">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
                          <div>
                            ...
                            <p className="text-sm font-bold text-green-400">${user.balance.toLocaleString()}</p>
                          </div>
                          <div>
          ...
          {selectedUser ? (
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <Select
                        ...
                        onValueChange={(value) => setSelectedUser({ ...selectedUser, membership: value })}
                      >
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setSelectedUser({ ...selectedUser, balance: Number.parseFloat(e.target.value) })
                        }
                        className="bg-gray-800/30 border-red-500/30 text-white"
                      />
                    </div>
                    ...
                    <div className="flex items-center justify-between p-3 bg-white/5 rounded-lg">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) => setSelectedUser({ ...selectedUser, verified: checked })}
            ...
            <Card className="bg-gray-900/60 border-red-500/30 backdrop-blur-xl">
              <CardContent className="p-12 text-center">
                ...
                <p className="text-gray-400">Choose a user from the User Management tab to edit their profile</p>
              </CardContent>
            </Card>
          )}
        </TabsContent>
              ...
              <CardContent>
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-purple-400 font-semibold">{users.filter((u) => u.verified).length}</span>
                  </div>
                </div>
              </CardContent>
            </Card>

...
export default function AdminDashboard() {
  ...
  const suspendUser = (userId) => {
    setUserProfiles((prev) => prev.map((user) => (user.id === userId ? { ...user, status: "suspended" } : user)))
  }

  const activateUser = (userId) => {
    setUserProfiles((prev) => prev.map((user) => (user.id === userId ? { ...user, status: "active" } : user)))
  }
    ...
    <div className="space-y-6">
          ...
          <CardTitle className="text-gray-100 flex items-center">
            <div className="flex items-center space-x-3">
              <div className="relative">
                ...
                <Crown size={16} className="text-yellow-400 absolute -top-1 -right-1 animate-bounce" />
              </div>
              <div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-4">
        <Card className="bg-gray-900/60 border-green-500/30 backdrop-blur-xl">
          <CardContent className="p-4 text-center">
            ...
            <p className="text-lg font-bold text-green-400">{adminStats.totalUsers.toLocaleString()}</p>
        ...
        <Card className="bg-gray-900/60 border-blue-500/30 backdrop-blur-xl">
          <CardContent className="p-4 text-center">
            ...
            <p className="text-lg font-bold text-blue-400">{adminStats.activeUsers.toLocaleString()}</p>
        ...
        <Card className="bg-gray-900/60 border-yellow-500/30 backdrop-blur-xl">
          <CardContent className="p-4 text-center">
            ...
            <p className="text-lg font-bold text-yellow-400">${(adminStats.totalRevenue / 1000000).toFixed(1)}M</p>
        ...
        <Card className="bg-gray-900/60 border-orange-500/30 backdrop-blur-xl">
          <CardContent className="p-4 text-center">
            ...
            <p className="text-lg font-bold text-orange-400">${(adminStats.dailyRevenue / 1000).toFixed(0)}K</p>
        ...
        <Card className="bg-gray-900/60 border-purple-500/30 backdrop-blur-xl">
          <CardContent className="p-4 text-center">
            ...
            <p className="text-lg font-bold text-purple-400">{adminStats.totalTrades.toLocaleString()}</p>
        ...
        <Card className="bg-gray-900/60 border-red-500/30 backdrop-blur-xl">
          <CardContent className="p-4 text-center">
            ...
            <p className="text-lg font-bold text-red-400">{adminStats.activeTrades.toLocaleString()}</p>
      ...
      <Tabs defaultValue="users" className="space-y-6">
        <TabsList className="bg-gray-900/60 border-red-500/30 backdrop-blur-xl">
          ...
          <TabsTrigger value="analytics" className="data-[state=active]:bg-red-500/20 data-[state=active]:text-red-300">
                      ...
                      <div className="flex items-center space-x-4">
                        ...
                        <div>
                          <div className="flex items-center space-x-2">
                            ...
                            <Badge className={`${getStatusColor(user.status)} border border-current`} variant="outline">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
                          <div>
                            ...
                            <p className="text-sm font-bold text-green-400">${user.accountValue.toLocaleString()}</p>
                          </div>
                          <div>
                            <p className="text-xs text-gray-400">Total Trades</p>
                            <p className="text-sm font-bold text-blue-400">{user.totalTrades.toLocaleString()}</p>
                          </div>
                          <div>
                          ...
                          <div>
                            ...
                            <p className="text-sm font-bold text-purple-400">{user.winRate.toFixed(1)}%</p>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="text-center">
                          ...
                          <div className="flex items-center">
                            ...
                            <Progress
                              ...
                              style={{
                                backgroundColor:
                                  user.riskScore > 8 ? "#ef4444" : user.riskScore > 5 ? "#eab308" : "#22c55e",
                              }}
                            />
                          </div>
                        </div>
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-3 bg-green-500/10 rounded-lg border border-green-500/30">
                    ...
                    <span className="text-green-400 font-bold text-xl">{liveData.realtimeUsers.toLocaleString()}</span>
                  </div>
                  <div className="flex items-center justify-between p-3 bg-blue-500/10 rounded-lg border border-blue-500/30">
                    <span className="text-gray-300">Trades/Second</span>
                    <span className="text-blue-400 font-bold text-xl">{liveData.tradesPerSecond.toFixed(1)}</span>
                  </div>
                    ...
                    >
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="text-gray-200 font-medium">{alert.type.toUpperCase()}</span>
                        </div>

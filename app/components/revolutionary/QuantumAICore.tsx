    ...
    <Card className="w-full overflow-hidden border-0 bg-gradient-to-br from-indigo-950 via-purple-900 to-violet-950">
      <CardHeader className="pb-2 pt-6 px-6">
        <div className="flex items-center justify-between">
          <Badge variant="outline" className="bg-indigo-500/10 text-indigo-300 border-indigo-500/20 px-3 py-1">
            QUANTUM TECHNOLOGY
          </Badge>
        ...
        <CardTitle className="text-2xl font-bold mt-2 text-white">Quantum AI Consciousness Core</CardTitle>
        ...
        <div className="grid gap-4">
          <div className="flex items-center gap-3 bg-indigo-500/10 p-3 rounded-lg">
            ...
            <div>
              ...
              <p className="text-xs text-indigo-300">Self-evolving consciousness with emotional intelligence</p>
            </div>
          </div>
          <div className="flex items-center gap-3 bg-purple-500/10 p-3 rounded-lg">
            ...
            <div>
              ...
              <p className="text-xs text-purple-300">Instantaneous market analysis across infinite dimensions</p>
            </div>
          </div>
          <div className="flex items-center gap-3 bg-violet-500/10 p-3 rounded-lg">
            ...
            <div>
              ...
              <p className="text-xs text-violet-300">Influence market reality through quantum fields</p>
            </div>
          </div>
        </div>
      </CardContent>

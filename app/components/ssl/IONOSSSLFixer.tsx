    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-indigo-900 p-6">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-300 text-lg">Follow these steps to fix ERR_SSL_PROTOCOL_ERROR on alphaaistockx.com</p>
        </div>
        ...
        <Alert className="mb-6 border-amber-500 bg-amber-950/50">
          ...
          <AlertDescription className="text-amber-200">
            ERR_SSL_PROTOCOL_ERROR means your SSL certificate isn't properly configured. This guide will fix it!
          </AlertDescription>
        </Alert>
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="p-4 bg-white/10 rounded-lg">
                ...
                <p className="text-white/90 mb-2">Use this online tool to check your SSL certificate status:</p>
                <Button
                  className="bg-white/20 hover:bg-white/30 text-white border-white/30"
                  onClick={() =>
                    window.open("https://www.ssllabs.com/ssltest/analyze.html?d=alphaaistockx.com", "_blank")
                  }
                >
                  Check SSL Status
                </Button>
              ...
              <div className="p-4 bg-white/10 rounded-lg">
                ...
                <p className="text-white/90">
                  Tell them: "I'm getting ERR_SSL_PROTOCOL_ERROR on my site alphaaistockx.com and need help with SSL
                  configuration"
                </p>
              </div>
            </div>
          ...
          <Card className="bg-gradient-to-r from-green-600 to-emerald-600 border-0 mt-6">
            <CardContent className="text-center py-8">
              ...
              <p className="text-white/90 mb-4">
                Your SSL should now be working correctly. It may take a few minutes for changes to take effect.
              </p>
              <Button
                className="bg-white/20 hover:bg-white/30 text-white border-white/30"

...
import { User, Camera, Palette, Trophy, Target, TrendingUp, Star, Crown, Flame, Shield, Eye } from "lucide-react"
...
export default function CustomizableProfile({ user, onUpdateProfile }) {
  ...
  const [achievements] = useState([
    { id: 1, name: "First Trade", description: "Completed your first trade", icon: Target, earned: true },
    { id: 2, name: "Profit Master", description: "Achieved 10% portfolio return", icon: TrendingUp, earned: true },
    { id: 3, name: "Diamond Hands", description: "Held a position for 6+ months", icon: Crown, earned: false },
    { id: 4, name: "Alpha Wolf", description: "Top 1% performer this month", icon: Flame, earned: true },
    { id: 5, name: "Risk Manager", description: "Never exceeded risk limits", icon: Shield, earned: false },
  ])
        ...
        <CardContent className="p-6">
          <div className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-6">
            <div className="relative">
              ...
              <Button size="sm" className="absolute -bottom-2 -right-2 rounded-full bg-purple-500 hover:bg-purple-600">
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <p className={`font-medium ${achievement.earned ? "text-yellow-400" : "text-gray-400"}`}>
                            {achievement.name}
                          </p>

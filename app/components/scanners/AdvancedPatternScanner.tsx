...
import { Brain, Target, Zap, BarChart3, Activity, Star, ArrowUp, ArrowDown, Search } from "lucide-react"
...
export default function AdvancedPatternScanner() {
  ...
  const chartPatterns = [
    ...
    { id: "double-top", name: "Double Top", type: "reversal", category: "classic", avgAccuracy: 72, avgMove: 8.3 },
    {
      id: "double-bottom",
      name: "Double Bottom",
      type: "reversal",
    ...
    { id: "triple-top", name: "Triple Top", type: "reversal", category: "classic", avgAccuracy: 69, avgMove: 7.8 },
    {
      id: "triple-bottom",
      name: "Triple Bottom",
      type: "reversal",
    ...
    { id: "bull-flag", name: "Bull Flag", type: "continuation", category: "flag", avgAccuracy: 85, avgMove: 18.6 },
    { id: "bear-flag", name: "Bear Flag", type: "continuation", category: "flag", avgAccuracy: 83, avgMove: 16.2 },
    {
      id: "bull-pennant",
      name: "Bull Pennant",
      type: "continuation",
    ...
    // Wedge Patterns
    { id: "rising-wedge", name: "Rising Wedge", type: "reversal", category: "wedge", avgAccuracy: 76, avgMove: 13.1 },
    { id: "falling-wedge", name: "Falling Wedge", type: "reversal", category: "wedge", avgAccuracy: 79, avgMove: 14.7 },
    {
      id: "broadening-wedge",
    ...
    // Diamond Patterns
    { id: "diamond-top", name: "Diamond Top", type: "reversal", category: "diamond", avgAccuracy: 64, avgMove: 8.9 },
    {
      id: "diamond-bottom",
      name: "Diamond Bottom",
      type: "reversal",
    ...
    { id: "runaway-gap", name: "Runaway Gap", type: "continuation", category: "gap", avgAccuracy: 75, avgMove: 11.7 },
    { id: "exhaustion-gap", name: "Exhaustion Gap", type: "reversal", category: "gap", avgAccuracy: 71, avgMove: 9.8 },
    { id: "common-gap", name: "Common Gap", type: "neutral", category: "gap", avgAccuracy: 55, avgMove: 3.2 },

    // Candlestick Patterns - Single Candle
    { id: "doji", name: "Doji", type: "reversal", category: "single-candle", avgAccuracy: 58, avgMove: 4.2 },
    {
      id: "long-legged-doji",
    ...
    { id: "hammer", name: "Hammer", type: "reversal", category: "single-candle", avgAccuracy: 72, avgMove: 8.4 },
    {
      id: "inverted-hammer",
    ...
    { id: "bat-bullish", name: "Bat Bullish", type: "reversal", category: "harmonic", avgAccuracy: 85, avgMove: 16.8 },
    { id: "bat-bearish", name: "Bat Bearish", type: "reversal", category: "harmonic", avgAccuracy: 84, avgMove: 16.3 },
    {
      id: "crab-bullish",
      name: "Crab Bullish",
      type: "reversal",
    ...
    { id: "dynamic-support", name: "Dynamic Support", type: "support", category: "sr", avgAccuracy: 71, avgMove: 8.2 },
    {
    ...
    { id: "rounded-top", name: "Rounded Top", type: "reversal", category: "complex", avgAccuracy: 71, avgMove: 9.7 },
    {
      id: "rounded-bottom",
      name: "Rounded Bottom",
      type: "reversal",
    ...
    { id: "v-top", name: "V-Top", type: "reversal", category: "complex", avgAccuracy: 67, avgMove: 8.9 },
    { id: "v-bottom", name: "V-Bottom", type: "reversal", category: "complex", avgAccuracy: 69, avgMove: 9.6 },
    ...
    { id: "horn-top", name: "Horn Top", type: "reversal", category: "specialized", avgAccuracy: 74, avgMove: 10.8 },
    {
      id: "horn-bottom",
      name: "Horn Bottom",
      type: "reversal",
  ...
  const generatePatternResults = () => {
    ...
    const results = symbols.slice(0, 15).map((symbol) => {
      ...
      const direction = pattern.type === "reversal" ? (Math.random() > 0.5 ? "bullish" : "bearish") : "bullish"
      const entryPrice = currentPrice * (1 + (Math.random() - 0.5) * 0.02)
      const targetPrice = direction === "bullish" ? entryPrice * (1 + avgMove / 100) : entryPrice * (1 - avgMove / 100)
    ...
    <div className="space-y-6">
      ...
      <Card className="bg-gray-900/90 border-red-500/30 backdrop-blur-xl">
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-6 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => setScanSettings((prev) => ({ ...prev, minVolume: Number.parseInt(e.target.value) }))}
          ...
          {/* Pattern Categories */}
          <div className="mt-6">
            <h4 className="text-gray-200 font-semibold mb-3">Pattern Categories ({chartPatterns.length} Total)</h4>
      ...
      <Card className="bg-gray-900/90 border-green-500/30 backdrop-blur-xl">
        <CardHeader>
          <CardTitle className="text-gray-100 flex items-center">
            ...
            <Badge className="ml-3 bg-gradient-to-r from-green-500 to-emerald-600 animate-pulse">🔴 LIVE</Badge>
          </CardTitle>
        </CardHeader>
        <CardContent>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-4">
                    <div>
                      <div className="flex items-center space-x-2">
                        ...
                        <Badge className={getStrengthColor(signal.strength)}>{signal.strength}</Badge>
                    ...
                    <div className="text-center">
                      ...
                      <p className="text-gray-100 font-semibold">${signal.currentPrice.toFixed(2)}</p>
                    </div>
                  ...
                  <div className="text-right">
                    <div className="space-y-1">
                      ...
                      <p className="text-xs text-gray-400">Accuracy: {signal.historicalAccuracy}%</p>
        ...
        <CardContent>
          {patternResults.length === 0 ? (
            <div className="text-center py-8">
              ...
              <p className="text-gray-400">No patterns found matching your criteria. Try adjusting the filters.</p>
            </div>
          ) : (
                    ...
                    <div className="flex items-center space-x-4">
                      <div>
                        <div className="flex items-center space-x-2">
                          ...
                          <Badge className={result.direction === "bullish" ? "bg-green-500" : "bg-red-500"}>
                            {result.pattern}
                          </Badge>
                        ...
                        <p className="text-sm text-gray-400">
                          {result.historicalMatches} historical matches • {result.successRate.toFixed(1)}% success rate
                        </p>
                      </div>

                      <div className="text-center">
                        <p className="text-gray-400 text-sm">Current Price</p>
                        <p className="text-gray-100 font-semibold">${result.currentPrice.toFixed(2)}</p>
                      </div>

                      <div className="text-center">
                        <p className="text-gray-400 text-sm">Entry</p>
                        <p className="text-red-400 font-semibold">${result.entryPrice.toFixed(2)}</p>
                      </div>

                      <div className="text-center">
                        <p className="text-gray-400 text-sm">Target</p>
                        <p className="text-green-400 font-semibold">${result.targetPrice.toFixed(2)}</p>
                      </div>

                      <div className="text-center">
                        <p className="text-gray-400 text-sm">Probability</p>
                        <div className="flex items-center">
                          <span className="text-red-400 font-bold">{result.probability.toFixed(0)}%</span>
                          <Star className="h-3 w-3 text-yellow-400 ml-1" />
                        </div>
                      </div>
                    </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {getPatternCategories()
              ...
              .map((category) => {
                ...
                const avgAccuracy =
                  categoryPatterns.reduce((sum, p) => sum + p.avgAccuracy, 0) / categoryPatterns.length
                const avgMove = categoryPatterns.reduce((sum, p) => sum + p.avgMove, 0) / categoryPatterns.length
                ...
                return (
                  ...
                  >
                    <div className="flex items-center justify-between mb-3">
                      <h4 className="text-gray-200 font-semibold">{category.replace("-", " ").toUpperCase()}</h4>
                      <Badge className={getCategoryColor(category)}>{categoryPatterns.length}</Badge>
                    </div>

                    <div className="space-y-2">
                      <div className="flex justify-between">
                        <span className="text-gray-400 text-sm">Avg Accuracy:</span>
                        <span className="text-green-400 font-semibold">{avgAccuracy.toFixed(1)}%</span>
                      </div>
                      <div className="flex justify-between">

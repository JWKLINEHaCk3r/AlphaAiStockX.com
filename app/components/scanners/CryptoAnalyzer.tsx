...
import { Bitcoin, TrendingUp, TrendingDown, Zap, Target, Activity, BarChart3, DollarSign } from "lucide-react"
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4">
        <Card className="bg-stone-900/40 border-orange-500/30 backdrop-blur-xl">
          <CardContent className="p-4 text-center">
            ...
            <p className="text-lg font-bold text-stone-100">{onChainMetrics.btcHashRate?.toFixed(0)} EH/s</p>
        ...
        <Card className="bg-stone-900/40 border-blue-500/30 backdrop-blur-xl">
          <CardContent className="p-4 text-center">
            ...
            <p className="text-lg font-bold text-stone-100">{onChainMetrics.ethGasPrice?.toFixed(0)} gwei</p>
        ...
        <Card className="bg-stone-900/40 border-emerald-500/30 backdrop-blur-xl">
          <CardContent className="p-4 text-center">
            ...
            <p className="text-lg font-bold text-stone-100">${onChainMetrics.totalValueLocked?.toFixed(0)}B</p>
        ...
        <Card className="bg-stone-900/40 border-purple-500/30 backdrop-blur-xl">
          <CardContent className="p-4 text-center">
            ...
            <p className="text-lg font-bold text-stone-100">{(onChainMetrics.activeAddresses / 1000)?.toFixed(0)}K</p>
        ...
        <Card className="bg-stone-900/40 border-red-500/30 backdrop-blur-xl">
          <CardContent className="p-4 text-center">
            ...
            <p className="text-lg font-bold text-stone-100">{onChainMetrics.exchangeInflows?.toFixed(0)}</p>
        ...
        <Card className="bg-stone-900/40 border-green-500/30 backdrop-blur-xl">
          <CardContent className="p-4 text-center">
            ...
            <p className="text-lg font-bold text-stone-100">{onChainMetrics.exchangeOutflows?.toFixed(0)}</p>
                      ...
                      <div className="flex items-center space-x-4">
                        <div>
                          <div className="flex items-center space-x-2">
                            ...
                            <Badge className={getSentimentColor(crypto.sentiment)}>{crypto.sentiment}</Badge>
                          </div>
                          <p className="text-sm text-stone-400">MCap: ${(crypto.marketCap / 1000).toFixed(1)}B</p>
                        </div>
                        ...
                        <div className="text-center">
                          ...
                          <p className="text-stone-100 font-semibold">${crypto.volume24h.toFixed(1)}B</p>
                        </div>

                        <div className="text-center">
                          <p className="text-stone-400 text-sm">AI Score</p>
                          <p className="text-emerald-400 font-semibold">{crypto.aiScore.toFixed(0)}</p>
                        </div>
            ...
            <CardContent>
              <div className="space-y-3">
                {defiMetrics.map((protocol, index) => (
                  <div key={index} className="p-4 bg-stone-800/30 rounded-lg border border-stone-600/30">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-4">
                        <div>
                          <span className="text-stone-100 font-bold">{protocol.name}</span>
                          <p className="text-sm text-stone-400">Risk Score: {protocol.riskScore}/100</p>
                        </div>

                        <div className="text-center">
                          <p className="text-stone-400 text-sm">TVL</p>
                          <p className="text-stone-100 font-semibold">${protocol.tvl.toFixed(1)}B</p>
                        </div>

                        <div className="text-center">
                          <p className="text-stone-400 text-sm">APY</p>
                          <p className="text-emerald-400 font-semibold">{protocol.apy.toFixed(1)}%</p>
                        </div>

                        <div className="text-center">
                          <p className="text-stone-400 text-sm">Volume 24h</p>
                          <p className="text-stone-100 font-semibold">${protocol.volume24h.toFixed(1)}B</p>
                        </div>

                        <div className="text-center">
                          <p className="text-stone-400 text-sm">Users 24h</p>
                          <p className="text-stone-100 font-semibold">{(protocol.users24h / 1000).toFixed(1)}K</p>
                        </div>
                      </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-4">
                        <div>
                          ...
                          <p className="text-sm text-stone-400">{collection.holders.toLocaleString()} holders</p>
                        </div>

                        <div className="text-center">
                          <p className="text-stone-400 text-sm">Floor Price</p>
                          <p className="text-stone-100 font-semibold">{collection.floorPrice} ETH</p>
                        </div>

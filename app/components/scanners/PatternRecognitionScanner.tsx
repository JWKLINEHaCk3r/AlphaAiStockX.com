                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-4">
                      ...
                      <div className="text-center">
                        ...
                        <p className="text-cyan-400 font-semibold">${result.entryPrice.toFixed(2)}</p>
                      </div>
                      ...
                      <div className="text-center">
                        <p className="text-gray-400 text-sm">Probability</p>
                        <div className="flex items-center">
                          <span className="text-cyan-400 font-bold">{result.probability.toFixed(0)}%</span>
                          <Star className="h-3 w-3 text-yellow-400 ml-1" />
                        </div>
                      </div>
                    </div>
              ...
              return (
                ...
                >
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <Badge className={pattern.type === "reversal" ? "bg-orange-500" : "bg-blue-500"}>
                      {pattern.type}
                    </Badge>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span
                        className={`font-semibold ${
                          (accuracy.avgReturn || pattern.avgMove) >= 0 ? "text-green-400" : "text-red-400"
                        }`}
                      >
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="text-gray-200">{accuracy.avgDaysToTarget || pattern.avgMove.toFixed(0)}</span>
                    </div>
                  </div>

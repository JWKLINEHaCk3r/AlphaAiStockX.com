...
export default function EarningsPredictor() {
  ...
  const generateUpcomingEarnings = () => {
    ...
    earnings.forEach((earning) => {
      const multiplier = earning.aiPrediction === "beat" ? 1.05 + Math.random() * 0.1 : 0.95 - Math.random() * 0.1
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-4">
                    <div>
                      <div className="flex items-center space-x-2">
                        ...
                        <Badge className={getPredictionColor(earning.aiPrediction)}>AI: {earning.aiPrediction}</Badge>
                      </div>
                    ...
                    <div className="text-center">
                      ...
                      <p className="text-stone-100 font-semibold">${earning.currentPrice.toFixed(2)}</p>
                    </div>
                    ...
                    <div className="text-center">
                      ...
                      <div className="flex items-center">
                        <span className="text-emerald-400 font-bold">{earning.confidenceScore.toFixed(0)}%</span>
                  ...
                  <div className="text-right">
                    <Badge className={getRatingColor(earning.analystRating)}>{earning.analystRating}</Badge>
                    <p className="text-xs text-stone-400 mt-1">Vol: {earning.volatilityExpected.toFixed(1)}%</p>
              ...
              >
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center space-x-2">
                    ...
                    <Badge className={getImpactColor(analysis.impact)}>{analysis.impact} Impact</Badge>
                  </div>
                  <div className="text-right">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-amber-400 font-medium">{analysis.historicalAccuracy}%</span>
                  </div>

  ...
  const successStories = [
    {
      ...
      role: "Day Trader",
      avatar: "SC",
      story: "Increased my win rate from 45% to 78% using AlphaAI's pattern recognition. Made $127K in 6 months!",
      returns: "+340%",
      timeframe: "6 months",
    },
    {
      ...
      avatar: "MR",
      story: "The AI analysis helped me identify market trends 3 weeks before they happened. Incredible accuracy!",
      returns: "+156%",
      timeframe: "1 year",
    },
    {
      ...
      role: "Options Trader",
      avatar: "JP",
      story: "The options flow scanner is a game-changer. I'm now consistently profitable with 85% win rate.",
      returns: "+289%",
      timeframe: "8 months",
    },
    {
      ...
      role: "Swing Trader",
      avatar: "DT",
      story: "Passed my Series 7 exam with 94% thanks to their education platform. Now managing $2M portfolio.",
      returns: "+198%",
      timeframe: "2 years",
    },
  ]
  ...
  return (
    <div className="space-y-8">
        ...
        <Card className="relative bg-slate-900/50 backdrop-blur-xl border-2 border-blue-500/30">
          <CardContent className="p-12 text-center">
            ...
            <p className="text-lg text-slate-400 mb-8 max-w-3xl mx-auto">
              Combining cutting-edge artificial intelligence, quantum computing, and decades of Wall Street expertise to
              revolutionize how you trade, learn, and succeed in financial markets.
            </p>
      ...
      <Card className="bg-slate-900/50 backdrop-blur-xl border-slate-700/50">
        <CardHeader>
          <CardTitle className="text-3xl text-white text-center mb-2">Revolutionary Features</CardTitle>
              ...
              return (
                <TabsContent key={feature.id} value={feature.id} className="space-y-6">
                  <div className="text-center mb-8">
                    ...
                    <p className="text-lg text-slate-300 max-w-2xl mx-auto">{feature.description}</p>
                  </div>

                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {feature.features.map((item, index) => (
                      <div key={index} className="flex items-start gap-3 p-4 bg-slate-800/30 rounded-lg">
      ...
      <Card className="bg-slate-900/50 backdrop-blur-xl border-slate-700/50">
        <CardHeader>
          <CardTitle className="text-3xl text-white text-center mb-2">Cutting-Edge Technology</CardTitle>
          <CardDescription className="text-center text-lg text-slate-300">
                ...
                <div key={index} className="space-y-4">
                  ...
                  <div className="space-y-2">
                    {category.technologies.map((tech, techIndex) => (
                      <div key={techIndex} className="flex items-center gap-3 p-3 bg-slate-800/30 rounded-lg">
      ...
      <Card className="bg-gradient-to-r from-blue-900/20 to-purple-900/20 border-2 border-blue-500/30 backdrop-blur-xl">
        <CardHeader>
          <CardTitle className="text-3xl text-white text-center mb-2">Why AlphaAIStockX is Amazing</CardTitle>
          <CardDescription className="text-center text-lg text-slate-300">
      ...
      <Card className="bg-gradient-to-r from-purple-900/30 to-blue-900/30 border-2 border-purple-500/50 backdrop-blur-xl">
        <CardContent className="p-12 text-center">
          ...
          <p className="text-xl text-slate-300 mb-8 max-w-2xl mx-auto">
            Join 50,000+ successful traders who are already using AlphaAIStockX to maximize their profits and master the
            markets with AI-powered precision.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <Button
              size="lg"
            ...
            <Button size="lg" variant="outline" className="text-lg px-8 py-4" onClick={() => onNavigate("education")}>

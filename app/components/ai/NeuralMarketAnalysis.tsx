        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="p-4 bg-blue-500/10 rounded-lg border border-blue-500/30">
              ...
              <p className="text-2xl font-bold text-white">{neuralAnalysis.marketSentiment?.overall.toFixed(0)}%</p>
            ...
            <div className="p-4 bg-green-500/10 rounded-lg border border-green-500/30">
              ...
              <p className="text-lg font-bold text-white">{neuralAnalysis.momentumAnalysis?.shortTerm.toUpperCase()}</p>
              <p className="text-sm text-gray-300">Strength: {neuralAnalysis.momentumAnalysis?.strength.toFixed(0)}%</p>
            ...
            <div className="p-4 bg-red-500/10 rounded-lg border border-red-500/30">
              ...
              <p className="text-lg font-bold text-white">{neuralAnalysis.riskAssessment?.level.toUpperCase()}</p>
              <p className="text-sm text-gray-300">Score: {neuralAnalysis.riskAssessment?.score.toFixed(0)}</p>
              <p className="text-xs text-gray-400 mt-1">

...
export default function AIInsiderUnusual() {
  ...
  const scanUnusual = () => {
    ...
    setTimeout(() => {
      setAlerts([
        { symbol: "MSFT", type: "Insider Buy", amount: "$12M", note: "AI: CEO purchased shares, bullish signal." },
        { symbol: "TSLA", type: "Dark Pool Spike", amount: "$8.5M", note: "AI: Unusual dark pool activity detected." },
        { symbol: "NVDA", type: "Block Trade", amount: "$20M", note: "AI: Large block trade, possible institutional move." },
      ])
      setLoading(false)
    }, 1200)
  }
  ...
  return (
    <div className="futuristic-card holo-shimmer p-6 mb-8">
      ...
      <p className="text-slate-300 mb-4">Detects and visualizes insider trades, dark pool, and block trades in real time.</p>
      <button className="holo-btn px-6 py-2 font-bold mb-4" onClick={scanUnusual} disabled={loading}>

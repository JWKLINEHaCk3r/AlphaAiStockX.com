...
export default function AIBacktester() {
  ...
  return (
    <div className="futuristic-card holo-shimmer p-6 mb-8">
      ...
      <p className="text-slate-300 mb-4">Lightning-fast, multi-strategy backtesting with explainable AI results.</p>
      <button className="holo-btn px-6 py-2 font-bold mb-4" onClick={runBacktest} disabled={loading}>

...
export default function AIPortfolioDoctor() {
  ...
  const runDoctor = () => {
    ...
    setTimeout(() => {
      setDiagnosis({
        ...
        aiNote: "AI: Portfolio is well-balanced. Consider increasing exposure to AI/tech for higher growth.",
        suggestions: [
  ...
  return (
    <div className="futuristic-card holo-shimmer p-6 mb-8">
      ...
      <p className="text-slate-300 mb-4">Automated, explainable portfolio health, risk, and optimization.</p>
      ...
      {diagnosis && (
        <div className="mt-4 futuristic-card p-4 animated-neon-border">
          ...
          <div className="text-cyan-300 font-bold mb-1">Diversification: {diagnosis.diversification}</div>

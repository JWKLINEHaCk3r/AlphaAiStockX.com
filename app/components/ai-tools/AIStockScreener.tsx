...
export default function AIStockScreener() {
  ...
  const runScreener = async () => {
    ...
    setTimeout(() => {
      setResults([
        { symbol: "NVDA", name: "NVIDIA Corp", score: 98, aiNote: "AI: Strong uptrend, high volume, bullish news." },
        { symbol: "TSLA", name: "Tesla Inc", score: 95, aiNote: "AI: Unusual options activity, positive sentiment." },
        { symbol: "AAPL", name: "Apple Inc", score: 92, aiNote: "AI: Breakout pattern detected, strong fundamentals." },
      ])
      setLoading(false)
    }, 1200)
  }
  ...
  return (
    <div className="futuristic-card holo-shimmer p-6 mb-8">
      ...
      <p className="text-slate-300 mb-4">Describe what you want (e.g. "AI, show me tech stocks with bullish momentum and low risk")</p>

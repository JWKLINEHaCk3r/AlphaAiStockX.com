...
export default function LiveTradingBot() {
  ...
  const executeTradeLogic = () => {
    ...
    if (aiConfidence >= botSettings.aiConfidenceThreshold && activeTrades.length < botSettings.maxConcurrentTrades) {
  ...
  const executeTrade = (symbol, confidence) => {
    ...
    const strategy = ["AI Momentum", "Mean Reversion", "Breakout", "News Sentiment"][Math.floor(Math.random() * 4)]
  ...
  const closeTrade = (tradeId) => {
    ...
    setBotStats((prev) => {
      ...
      return {
        ...prev,
        winRate,
        avgWin: wins > 0 ? tradeHistory.filter((t) => t.pnl > 0).reduce((sum, t) => sum + t.pnl, 0) / wins : 0,
        avgLoss:
          losses > 0 ? Math.abs(tradeHistory.filter((t) => t.pnl <= 0).reduce((sum, t) => sum + t.pnl, 0)) / losses : 0,
      }
    })
  }
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <CardTitle className="text-gray-100 flex items-center">
              ...
              >
                {botStatus === "running" ? "🟢 LIVE TRADING" : botStatus === "paused" ? "⏸️ PAUSED" : "⏹️ STOPPED"}
              </Badge>
            </CardTitle>
        ...
        <CardContent>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-4">
            ...
            <div className="text-center p-3 bg-gray-800/50 rounded-lg border border-cyan-500/20">
              ...
              <p className="text-lg font-bold text-gray-100">{marketAnalysis.sentiment?.toFixed(0) || 0}%</p>
            </div>
              ...
              <div className="p-4 bg-gradient-to-r from-cyan-500/10 to-blue-500/10 rounded-lg border border-cyan-500/30">
                ...
                <div className="space-y-2">
                  <div className="flex justify-between">
                    ...
                    <Badge className={marketAnalysis.marketTrend === "bullish" ? "bg-green-500" : "bg-red-500"}>
        ...
        <CardContent>
          {activeTrades.length === 0 ? (
            <div className="text-center py-8">
              ...
              <p className="text-gray-400">No active trades. Bot is analyzing market for opportunities...</p>
            </div>
          ) : (
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-4">
                      ...
                      <div className="text-center">
                        ...
                        <p className="text-gray-100 font-semibold">${trade.currentPrice.toFixed(2)}</p>
                      </div>
        ...
        <CardContent>
          {tradeHistory.length === 0 ? (
            <div className="text-center py-8">
              ...
              <p className="text-gray-400">No completed trades yet. Start the bot to begin trading!</p>
            </div>
          ) : (
              ...
              {tradeHistory.slice(0, 10).map((trade) => (
                ...
                >
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-gray-400 text-xs">{trade.exitTime.toLocaleTimeString()}</span>
                  </div>
                </div>
              ))}
            </div>

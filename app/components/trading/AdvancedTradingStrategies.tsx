  ...
  return (
    <div className="space-y-8">
        ...
        <Card className="bg-gradient-to-r from-gray-900/90 to-black/90 border-2 border-cyan-400/50 backdrop-blur-xl shadow-2xl shadow-cyan-500/25">
          <CardHeader>
            <CardTitle className="text-white flex items-center text-2xl">
              <Activity className="h-8 w-8 mr-3 text-cyan-400 animate-pulse" />🔥 LIVE STRATEGY PERFORMANCE
                  ...
                  >
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center space-x-4">
                        <div className={`p-3 bg-gradient-to-r ${strategy.color} rounded-full ${strategy.glowColor}`}>
                      ...
                      <div className="text-right">
                        <p className={`text-2xl font-bold ${perf.currentPnL >= 0 ? "text-green-400" : "text-red-400"}`}>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-6 gap-4">
                      ...
                      <div className="text-center p-3 bg-black/30 rounded-lg border border-green-400/20">
                        <p className="text-green-400 font-bold text-lg">{perf.todayWinRate?.toFixed(1) || 0}%</p>
                        <p className="text-xs text-gray-400">Win Rate</p>
                      </div>
                      <div className="text-center p-3 bg-black/30 rounded-lg border border-purple-400/20">
                        <p className="text-purple-400 font-bold text-lg">{perf.signalsGenerated || 0}</p>
                      ...
                      <div className="text-center p-3 bg-black/30 rounded-lg border border-yellow-400/20">
                        <p className="text-yellow-400 font-bold text-lg">{perf.executionSpeed?.toFixed(0) || 0}ms</p>
                      ...
                      <div className="text-center p-3 bg-black/30 rounded-lg border border-red-400/20">
                        <p className="text-red-400 font-bold text-lg">{perf.currentDrawdown?.toFixed(1) || 0}%</p>
      ...
      <Card className="bg-gradient-to-r from-gray-900/90 to-black/90 border-2 border-purple-400/50 backdrop-blur-xl shadow-2xl shadow-purple-500/25">
        <CardHeader>
          <CardTitle className="text-white flex items-center text-2xl">
            <Brain className="h-8 w-8 mr-3 text-purple-400 animate-pulse" />💎 PROVEN TRADING ALGORITHMS
                ...
                >
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="text-purple-400">{strategy.totalTrades.toLocaleString()}</span>
                    </div>
                  </div>

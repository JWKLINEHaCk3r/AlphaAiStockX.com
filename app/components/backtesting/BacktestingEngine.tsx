...
import { CalendarIcon, Play, BarChart3, TrendingUp, Target, DollarSign, Activity, Zap } from "lucide-react"
...
export default function BacktestingEngine() {
  ...
  const strategies = [
    ...
    { id: "fibonacci-retracement", name: "Fibonacci Retracement", type: "Technical", winRate: 69.1 },
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setBacktestConfig((prev) => ({ ...prev, initialCapital: Number.parseInt(e.target.value) }))
                  }
              ...
              <div className="grid grid-cols-2 gap-2">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setBacktestConfig((prev) => ({ ...prev, commission: Number.parseFloat(e.target.value) }))
                    }
                    className="bg-gray-800/30 border-red-500/30 text-gray-200"
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setBacktestConfig((prev) => ({ ...prev, slippage: Number.parseFloat(e.target.value) }))
                    }
                    className="bg-gray-800/30 border-red-500/30 text-gray-200"
                  />
                </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setBacktestConfig((prev) => ({ ...prev, maxPositionSize: Number.parseFloat(e.target.value) / 100 }))
                  }
                  className="bg-gray-800/30 border-red-500/30 text-gray-200"
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setBacktestConfig((prev) => ({ ...prev, riskPerTrade: Number.parseFloat(e.target.value) / 100 }))
                  }
                  className="bg-gray-800/30 border-red-500/30 text-gray-200"
                />
              </div>
              ...
              <div className="grid grid-cols-2 gap-2">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setBacktestConfig((prev) => ({ ...prev, stopLoss: Number.parseFloat(e.target.value) / 100 }))
                    }
                    className="bg-gray-800/30 border-red-500/30 text-gray-200"
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setBacktestConfig((prev) => ({ ...prev, takeProfit: Number.parseFloat(e.target.value) / 100 }))
                    }
                    className="bg-gray-800/30 border-red-500/30 text-gray-200"
                  />
                </div>
          ...
          <Card className="bg-gray-900/90 border-green-500/30 backdrop-blur-xl">
            <CardHeader>
              <CardTitle className="text-gray-100 flex items-center">
                ...
                <Badge className="ml-3 bg-gradient-to-r from-green-500 to-emerald-600">{backtestResults.period}</Badge>
              </CardTitle>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-4">
                ...
                <div className="text-center p-3 bg-gray-800/50 rounded-lg border border-green-500/20">
                  ...
                  <p className="text-lg font-bold text-blue-400">{backtestResults.winRate.toFixed(1)}%</p>
                </div>

                <div className="text-center p-3 bg-gray-800/50 rounded-lg border border-green-500/20">
                  <Activity className="h-6 w-6 text-purple-400 mx-auto mb-1" />
                  <p className="text-sm text-gray-400">Sharpe Ratio</p>
                  <p className="text-lg font-bold text-purple-400">{backtestResults.sharpeRatio.toFixed(2)}</p>
                </div>

                <div className="text-center p-3 bg-gray-800/50 rounded-lg border border-green-500/20">
                  <BarChart3 className="h-6 w-6 text-red-400 mx-auto mb-1" />
                  <p className="text-sm text-gray-400">Max Drawdown</p>
                  <p className="text-lg font-bold text-red-400">{backtestResults.maxDrawdown.toFixed(2)}%</p>
                </div>

                <div className="text-center p-3 bg-gray-800/50 rounded-lg border border-green-500/20">
                  <DollarSign className="h-6 w-6 text-yellow-400 mx-auto mb-1" />
                  <p className="text-sm text-gray-400">Final Capital</p>
                  <p className="text-lg font-bold text-yellow-400">${backtestResults.finalCapital.toLocaleString()}</p>
                </div>
                ...
                <div className="text-center p-3 bg-gray-800/50 rounded-lg border border-green-500/20">
                  ...
                  <p className="text-lg font-bold text-indigo-400">{backtestResults.profitFactor.toFixed(2)}</p>
                </div>

                <div className="text-center p-3 bg-gray-800/50 rounded-lg border border-green-500/20">
                  <Zap className="h-6 w-6 text-pink-400 mx-auto mb-1" />
                  <p className="text-sm text-gray-400">Calmar Ratio</p>
                  <p className="text-lg font-bold text-pink-400">{backtestResults.calmarRatio.toFixed(2)}</p>
                </div>
              </div>
            </CardContent>
          </Card>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between">
                      ...
                      <span className="text-green-400 font-semibold">{backtestResults.winningTrades}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-400">Losing Trades:</span>
                      <span className="text-red-400 font-semibold">{backtestResults.losingTrades}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-400">Average Win:</span>
                      <span className="text-green-400 font-semibold">{backtestResults.avgWin.toFixed(2)}%</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-400">Average Loss:</span>
                      <span className="text-red-400 font-semibold">{backtestResults.avgLoss.toFixed(2)}%</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-400">Largest Win:</span>
                      <span className="text-green-400 font-semibold">{backtestResults.largestWin.toFixed(2)}%</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-400">Largest Loss:</span>
                      <span className="text-red-400 font-semibold">{backtestResults.largestLoss.toFixed(2)}%</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between">
                      ...
                      <span className="text-blue-400 font-semibold">{backtestResults.sortinoRatio.toFixed(2)}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-400">Volatility:</span>
                      <span className="text-yellow-400 font-semibold">{backtestResults.volatility.toFixed(2)}%</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-400">Beta:</span>
                      <span className="text-purple-400 font-semibold">{backtestResults.beta.toFixed(2)}</span>
                    </div>
                    <div className="flex justify-between">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="text-green-400 font-semibold">{backtestResults.consecutiveWins}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-400">Consecutive Losses:</span>
                      <span className="text-red-400 font-semibold">{backtestResults.consecutiveLosses}</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between">
                      ...
                      <span className="text-gray-200 font-semibold">{backtestResults.tradingDays}</span>
                    </div>
                    <div className="flex justify-between">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className={`font-semibold ${getReturnColor(backtestResults.totalReturn)}`}>
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className={`font-semibold ${getReturnColor(backtestResults.totalReturn)}`}>
                        ${(backtestResults.finalCapital - backtestResults.initialCapital).toLocaleString()}
                      </span>
                    </div>
                  </div>
                </div>

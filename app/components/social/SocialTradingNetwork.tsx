  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="bg-gradient-to-r from-purple-900/20 to-pink-900/20 border-purple-400/30 backdrop-blur-xl">
        <CardHeader>
          <CardTitle className="text-white flex items-center text-2xl">
            <Users className="h-7 w-7 mr-3 text-purple-400" />👥 Social Trading Network
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
            <div className="p-4 bg-blue-500/10 rounded-lg border border-blue-400/30 text-center">
              ...
              <div className="text-2xl font-bold text-blue-400">{copyTradingStats.totalCopiers?.toLocaleString()}</div>
            ...
            <div className="p-4 bg-yellow-500/10 rounded-lg border border-yellow-400/30 text-center">
              ...
              <div className="text-2xl font-bold text-yellow-400">{copyTradingStats.averageReturn?.toFixed(1)}%</div>
            ...
            <div className="p-4 bg-purple-500/10 rounded-lg border border-purple-400/30 text-center">
              ...
              <div className="text-2xl font-bold text-purple-400">{copyTradingStats.successRate?.toFixed(1)}%</div>
            ...
            <div className="p-4 bg-cyan-500/10 rounded-lg border border-cyan-400/30 text-center">
              ...
              <div className="text-2xl font-bold text-cyan-400">{copyTradingStats.activeTrades?.toLocaleString()}</div>
      ...
      <Card className="bg-gradient-to-r from-cyan-900/20 to-blue-900/20 border-cyan-400/30 backdrop-blur-xl">
        <CardHeader>
          <CardTitle className="text-white flex items-center text-2xl">
            <Trophy className="h-7 w-7 mr-3 text-cyan-400" />🏆 Top Performing Traders
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <div className="flex items-center space-x-2">
                        ...
                        <Badge className={`bg-gradient-to-r ${getBadgeColor(trader.badge)} text-black`}>
                          {trader.badge}
                        </Badge>
                      </div>
      ...
      <Card className="bg-gradient-to-r from-green-900/20 to-emerald-900/20 border-green-400/30 backdrop-blur-xl">
        <CardHeader>
          <CardTitle className="text-white flex items-center text-2xl">
            <MessageCircle className="h-7 w-7 mr-3 text-green-400" />💬 Trading Social Feed
        ...
        <CardContent>
                      ...
                      <div className="p-4 bg-gray-800/50 rounded-lg border border-gray-600/30 mb-4">
                        <div className="flex items-center justify-between">
                          <div className="flex items-center space-x-4">
                            ...
                            <span className="text-gray-400">${post.trade.amount.toLocaleString()}</span>
                          </div>
                          {post.trade.profit && (
                            <div className="text-right">
                              <span className="text-green-400 font-bold">+{post.trade.profit}%</span>
                            </div>
                          )}
                        </div>
                      </div>
          ...
          <div className="mt-6 p-6 bg-gradient-to-r from-blue-500/10 to-purple-500/10 rounded-lg border border-blue-400/30">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  <Input placeholder="Symbol (e.g., AAPL)" className="bg-black/20 border-blue-400/30 text-white w-32" />
                  <Input placeholder="Action" className="bg-black/20 border-blue-400/30 text-white w-24" />
                  <Input placeholder="Amount" className="bg-black/20 border-blue-400/30 text-white w-32" />
                </div>
      ...
      <Card className="bg-gradient-to-r from-yellow-900/20 to-orange-900/20 border-yellow-400/30 backdrop-blur-xl">
        <CardHeader>
          <CardTitle className="text-white flex items-center text-2xl">
            <BarChart3 className="h-7 w-7 mr-3 text-yellow-400" />📊 Monthly Leaderboard
        ...
        <CardContent>
          ...
          <div className="mt-6 p-4 bg-gradient-to-r from-purple-500/10 to-pink-500/10 rounded-lg border border-purple-400/30 text-center">
            ...
            <p className="text-gray-300 mb-4">Compete with top traders and win monthly prizes up to $50,000</p>

            ...
            {[
              ...
              return (
                <g key={m.name}>
                  ...
                  <text x={x + 14} y={y + 4} fontSize="13" fill="#fff" opacity="0.9" style={{textShadow:'0 0 8px #a78bfa'}}> {m.name} </text>
                </g>
              )
            })}
          </svg>
          <div className="absolute top-2 left-4 flex items-center gap-2 text-fuchsia-300 text-lg font-bold drop-shadow-lg">
            <span className="w-5 h-5 inline-block animate-spin-slow"><svg viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="10" stroke="#a78bfa" strokeWidth="2" opacity="0.5"/><circle cx="12" cy="12" r="6" stroke="#a78bfa" strokeWidth="2"/></svg></span>

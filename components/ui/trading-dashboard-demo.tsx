...
function LiveChart({ className }: { className?: string }) {
  ...
  return (
    <div className={`h-32 relative overflow-hidden rounded-lg ${className}`}>
      ...
      <CardContent className="p-4">
        ...
        <div className="flex items-center justify-between mb-3">
          ...
          <div className="text-right">
            ...
            <div className="text-lg font-bold text-blue-400">{stock.aiScore}/100</div>
          </div>
        </div>
      ...
      <CardContent className="space-y-4">
        <div className="grid grid-cols-3 gap-4">
          <div className="text-center">
            <div className="text-2xl font-bold text-green-500">{sentiment.bullish}%</div>
        ...
        <div className="space-y-2">
          <div className="flex justify-between text-sm">
            ...
            <span className="text-blue-400">{sentiment.aiConfidence}%</span>
          </div>
            ...
            <Card className="glass-card">
              ...
              <CardContent>
                <div className="grid grid-cols-2 md: grid-cols-4 gap-6">
                  ...
                  <div className="text-center">
                    <div className="text-2xl font-bold text-blue-400">+47.3%</div>
                    <div className="text-sm text-muted-foreground">This Month</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-purple-400">+156.7%</div>
                    <div className="text-sm text-muted-foreground">YTD</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-orange-400">0.003s</div>
              ...
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  ...
                  >
                    ...
                    <div className="text-sm font-medium text-green-500">BUY</div>
                  </div>
                ))}
              </CardContent>
            </Card>

...
const mockStocks: StockData[] = [
  { symbol: 'AAPL', price: 178.42, change: 2.35, changePercent: 1.33, volume: 45231000, aiScore: 87 },
  { symbol: 'NVDA', price: 489.33, change: -5.67, changePercent: -1.15, volume: 52341000, aiScore: 94 },
  { symbol: 'TSLA', price: 245.67, change: 8.45, changePercent: 3.56, volume: 67894000, aiScore: 79 },
  { symbol: 'MSFT', price: 352.18, change: 1.89, changePercent: 0.54, volume: 32156000, aiScore: 91 },
];
      ...
      <svg className="w-full h-full" viewBox="0 0 300 128">
        ...
        {dataPoints.length > 1 && (
          <>
            {/* Area under curve */}
            <path
              d={`M 0 128 ${dataPoints.map((point, index) => 
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
            Experience real-time AI-powered trading with our advanced dashboard. Watch as our neural networks 
            analyze market data and execute trades with superhuman precision.
          </p>

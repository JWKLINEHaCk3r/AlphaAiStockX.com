...
export function ScrollProgress() {
 ...
 // Early return for SSR; if (typeof window === 'undefined') {
    return null;
  }
 ...
 // Early return for SSR; if (typeof window === 'undefined') {
  ...
  useEffect(() => {   // Skip during SSR; if (typeof window === 'undefined') return;
    ...
    duration: Math.random() * 3 + 2;
      ...
      setCharacters(newCharacters); } catch (error) { console.warn('MatrixRain initialization failed during SSR:', error);
    }
  }, []);
...
export function AIConsciousnessOrb() { // Early return for SSR; if (typeof window === 'undefined') {
    return null;
  }

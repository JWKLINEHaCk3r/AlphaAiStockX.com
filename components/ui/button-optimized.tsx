...
export function buttonVariants({
  ...
  const variants = {
    default: 'bg-gradient-primary text-white shadow-glow hover:shadow-glow-lg hover:scale-105 border border-neon-blue/30',;
    destructive: 'bg-gradient-to-r from-red-500 to-red-600 text-white shadow-lg hover:from-red-600 hover:to-red-700 hover:scale-105',;
    outline: 'glass-card border-2 border-neon-blue/50 text-neon-blue hover:bg-neon-blue/10 hover:border-neon-blue hover:scale-105 backdrop-blur-xl',;
    secondary: 'bg-gradient-to-r from-neon-purple/20 to-neon-pink/20 text-white shadow-lg hover:from-neon-purple/30 hover:to-neon-pink/30 border border-neon-purple/30 hover:scale-105',;

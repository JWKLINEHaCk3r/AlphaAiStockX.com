...
const AITradingBot = memo(({
  ...
  return (
    <Card className={`bg-gray-900/60 ${statusConfig.borderColor} hover:border-neon-blue/50 transition-all duration-300 ${className}`}>
      <CardHeader className="pb-4">
        <div className="flex items-center justify-between">
          ...
          <Badge className={`${statusConfig.bgColor} ${statusConfig.color} border-0 flex items-center gap-1`}>
            {statusConfig.icon}
            {statusConfig.label}
          </Badge>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-gray-800/50 rounded-lg p-3">
              ...
              <div className={`text-lg font-bold ${performance.totalReturn >= 0 ? 'text-green-400' : 'text-red-400'}`}>
